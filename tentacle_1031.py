def tentacle(input_data):
    ...
    if isinstance(input_data, str) and input_data.strip().lower().startswith('<!doctype'):
        ...
        if 'data analysis' in lowercase_input:
            ...
            if 'science' in lowercase_input:
                return "science html document detected"
            elif 'technology' in lowercase_input:
                return "technology html document detected"
            else:
    ...
    try:
        ...
        if isinstance(input_data, str):
            ...
            elif 'math' in processed_items or 'equation' in processed_items:
            ...
            elif 'science' in processed_items:
                return f"{processed_items}, science detected"
            elif 'technology' in processed_items:
                return f"{processed_items}, technology detected"
            else:
