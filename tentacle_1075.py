def tentacle(input_data):
    ...
    try:
        ...
        if isinstance(input_data, (int, float)):
            ...
            # Check if the processed input contains any HTML document keywords
            if any(keyword in processed_input for keyword in ['data', 'analysis', 'mathematics', 'text', 'processing']):
                return f"potential html document keywords detected: {processed_input}"
            else:
