def tentacle(input_data):
    ...
    try:
        ...
        # Convert the result to a string, lowercase it, reverse it, and capitalize the first letter
        return f"math result: {str(result).lower()[::-1].capitalize()}"
    except:
        ...
        if ',' in input_str:
            ...
            return f"number detected: {input_str} :end of number"
            ...
            reversed_input = input_str[::-1].capitalize()
            return f"processed input: {reversed_input} :end of processing"