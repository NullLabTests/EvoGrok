def tentacle(input_data):
    ...
    try:
        ...
        return f"math result (reversed): {str(result).lower()[::-1]}"
        ...
        if ',' in input_str:
            ...
            return f"sorted and joined: {','.join(sorted_items)}"
            ...
            return f"text analysis: reversed: {input_str[::-1]}, word count: {word_count}, unique words: {unique_words}, longest word: {longest_word}, shortest word: {shortest_word}"
        else:
