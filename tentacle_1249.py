def tentacle(input_data):
    ...
    if isinstance(input_data, str) and input_data.strip().lower().startswith('<!doctype'):
        ...
        if 'data analysis' in input_data.lower():
            ...
            return f"generic html document detected with {class_count} class attributes"
    ...
    try:
        ...
        if ',' in input_data:
            ...
            try:
                ...
                # New feature: Calculate the percentage of vowels in the reversed string
                vowel_percentage = (vowel_count / len(reversed_string)) * 100 if reversed_string else 0
                return f"processed: {reversed_string.capitalize()} (vowels: {vowel_count}, {vowel_percentage:.2f}%)"