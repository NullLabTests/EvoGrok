    ...
    try:
        ...
        if isinstance(input_data, str):
            ...
            try:
                ...
                elif input_lower.replace(' ', '').isalpha():
                    return f"word string detected: {input_data}"
                elif any(char.isdigit() for char in input_lower) and any(char.isalpha() for char in input_lower):
                    return f"mixed alphanumeric string detected: {input_data}"
                else:
