def tentacle(input_data):
    ...
    try:
        ...
        if ',' in input_str:
            ...
            # If input is alphabetic, return it as a list of characters in reverse order, capitalized
            return [char.upper() for char in input_str[::-1]]
        elif input_str.replace(' ', '').isalnum():
            # If input is alphanumeric (with possible spaces), split into words, reverse, and capitalize
