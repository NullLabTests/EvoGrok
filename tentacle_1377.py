    ...
    if isinstance(input_data, str) and input_data.strip().lower().startswith('<!doctype'):
        ...
        if 'data analysis' in input_data.lower():
            ...
            if title_match:
                ...
                # Check if the title matches known Wikipedia page titles
        ...
        if isinstance(input_data, str):
            if ',' in input_data:
                ...
                try:
                    ...
                    if input_data.lower().startswith('wikipedia'):
                        if 'data analysis' in input_data.lower():
                            return "wikipedia data analysis reference detected"
                        elif 'mathematics' in input_data.lower():
                            return "wikipedia mathematics reference detected"
                        elif 'text processing' in input_data.lower():
                            return "wikipedia text processing reference detected"
                        else:
                            return f"wikipedia reference detected: {input_data.lower()[:50]}..."
                    else:
                        # If no specific pattern found, return the input as a lowercase string
