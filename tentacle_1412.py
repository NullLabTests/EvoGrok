        ...
        if isinstance(result, (int, float)):
            ...
            if url_pattern.match(result):
                ...
                if 'data analysis' in result.lower():
                    return 'data analysis html document detected in evaluated string'
                elif 'mathematics' in result.lower():
                    return 'mathematics html document detected in evaluated string'
                elif 'text processing' in result.lower():
                    return 'text processing html document detected in evaluated string'
                else:
