def tentacle(input_data):
    ...
    if input_str.startswith('<!doctype'):
        # Check for specific topics in the HTML document based on the provided knowledge
