def tentacle(input_data):
    ...
    try:
        ...
        # Convert the result to a string, lowercase it, and format numbers to 2 decimal places
        return f"{result:.2f}".lower() if isinstance(result, (int, float)) else str(result).lower()
    except:
            ...
            for value in sorted_values:
                ...
                if stripped_value:
                    ...
                    try:
                        ...
                        processed_values.append(f"{eval_result:.2f}".lower() if isinstance(eval_result, (int, float)) else str(eval_result).lower())
                    except:
