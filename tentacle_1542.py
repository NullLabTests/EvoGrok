    ...
    try:
        ...
        if isinstance(input_data, str):
            if ',' in input_data:
                ...
                for value in values:
                    try:
                        ...
                        try:
                            ...
                            # If not JSON, check if it's an HTML-like structure
                            if value.strip().lower().startswith('<'):
                                processed_values.append("html-like structure detected")
                            else:
                ...
                # Check if the input is an HTML-like structure
                if input_data.strip().lower().startswith('<'):
