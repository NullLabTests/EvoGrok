...
def tentacle(input_data):
    ...
    if isinstance(input_data, str) and input_data.strip().lower().startswith('<!doctype'):
        ...
        elif re.search(r'wikipedia', input_data, re.IGNORECASE):
                ...
                for value in values:
                    try:
                        ...
                        try:
                            ...
                            # If not JSON, check if it's an HTML document
                            if value.strip().lower().startswith('<!doctype'):
                                processed_values.append(tentacle(value))
                            else:
