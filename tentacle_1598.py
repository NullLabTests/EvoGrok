        ...
        if 'data analysis' in result:
            ...
            try:
                ...
                if acronyms:
                    ...
                    programming_keywords = ['if', 'else', 'for', 'while', 'def', 'class', 'import', 'from']
                    detected_keywords = [word for word in words if word in programming_keywords]
                    if detected_keywords:
                        return f"Possible programming code detected with keywords: {', '.join(detected_keywords)} in '{result}'"
                    else:
                        return result