def tentacle(input_data):
    ...
    try:
        ...
        if 'data analysis' in result_str or 'wikipedia' in result_str:
            return f"{result_str}, wikipedia data analysis html document detected"
        elif 'mathematics' in result_str or 'wikipedia' in result_str:
            return f"{result_str}, wikipedia mathematics html document detected"
        elif 'text processing' in result_str or 'wikipedia' in result_str:
        ...
        # Check if the result contains any of the HTML document types
        if 'data analysis' in result or 'wikipedia' in result:
            return f"{result}, wikipedia data analysis html document detected"
        elif 'mathematics' in result or 'wikipedia' in result:
            return f"{result}, wikipedia mathematics html document detected"
        elif 'text processing' in result or 'wikipedia' in result:
