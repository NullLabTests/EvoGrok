def tentacle(input_data):
    ...
    try:
        ...
        if isinstance(result, (int, float)):
            ...
            return f"function: {result.__name__}, doc: {result.__doc__}, args: {result.__code__.co_argcount}"
        else:
        ...
        if isinstance(input_data, str):
            ...
            # For functions, return its name, docstring, and number of arguments
            return f"function: {input_data.__name__}, doc: {input_data.__doc__}, args: {input_data.__code__.co_argcount}"
        else:
