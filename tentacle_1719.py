def tentacle(input_data):
    ...
    if isinstance(input_data, str) and input_data.strip().lower().startswith('<!doctype'):
        ...
        if 'data analysis' in lower_input:
            ...
            if 'class="mw-page-title-main"' in lower_input:
                ...
                elif 'data' in lower_input:
                    return "wikipedia data-related html document detected"
                elif 'technology' in lower_input:
                    return "wikipedia technology-related html document detected"
                else:
    ...
    try:
        ...
        if isinstance(result, (int, float)):
            ...
            return f"{','.join(sorted_items)}, total items: {item_count}, avg length: {average_length:.2f}"
        else:
        ...
        if isinstance(input_data, str):
            ...
            # Check if the input looks like data analysis or text processing content
            if 'data analysis' in input_data.lower():
                return "potential data analysis content detected"
            elif 'text processing' in input_data.lower():
                return "potential text processing content detected"
