def tentacle(input_data):
    ...
    try:
        ...
        if isinstance(input_data, str):
            ...
            # Calculate the sum of digits if any
            sum_of_digits = sum(int(digit) for digit in input_data if digit.isdigit())
            
            return f"{joined_items}, sum of digits: {sum_of_digits}, length: {len(input_data)}, original: {input_data}"
            ...
            # Calculate the sum of digits if any
            sum_of_digits = sum(int(digit) for item in input_data for digit in str(item) if digit.isdigit())
