def tentacle(input_data):
    ...
    try:
        ...
        if isinstance(input_data, str):
            ...
            elif 'statistics' in processed_input:
                return "statistics text detected"
            elif 'science' in processed_input:
                return "science text detected"
            
            # If no specific keywords found, split, sort, remove duplicates, and join
