def tentacle(input_data):
        ...
        if 'data analysis' in lower_input:
            ...
            if 'class="mw-page-title-main"' in lower_input:
                ...
                if 'class="vector-body"' in lower_input:
                    ...
                    return "mediawiki html document detected"
                else:
    ...
    try:
        ...
        if isinstance(result, (int, float)):
            ...
            return f"function: {result.__name__}, doc: {result.__doc__}"
        else:
        ...
        if isinstance(input_data, str):
            ...
            return f"function: {input_data.__name__}, doc: {input_data.__doc__}"
        else:
