def tentacle(input_data):
    ...
    if isinstance(input_data, str) and input_data.strip().lower().startswith('<!doctype'):
        ...
        if 'data analysis' in lower_input:
            ...
            if 'class="mw-page-title-main"' in lower_input:
                ...
                elif '<svg' in lower_input:
                    return "svg document detected"
                else:
    ...
    try:
        ...
        if isinstance(result, (int, float)):
            ...
            sorted_items = sorted((str(k).lower(), str(v).lower()) for k, v in result.items())
        ...
        if isinstance(input_data, str):
            ...
            # For dictionaries, sort keys, and join key-value pairs
            sorted_items = sorted((str(k).lower(), str(v).lower()) for k, v in input_data.items())
            return ','.join(f"{k}:{v}" for k, v in sorted_items)
        else:
