def tentacle(input_data):
    ...
    # New feature: Check for specific keywords related to Wikipedia topics
    if isinstance(input_data, str):
        lower_input = input_data.lower()
        if 'data analysis' in lower_input or 'statistics' in lower_input:
            return "potential wikipedia data analysis or statistics content detected"
        elif 'mathematics' in lower_input:
            return "potential wikipedia mathematics content detected"
        elif 'text processing' in lower_input:
            return "potential wikipedia text processing content detected"
        elif 'science' in lower_input:
            return "potential wikipedia science content detected"
