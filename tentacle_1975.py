def tentacle(input_data):
    ...
    try:
        ...
        if isinstance(result, (int, float)):
            ...
            unique_count = len(sorted_keys)
            return f"{','.join(sorted_keys)}, unique keys: {unique_count}"
        else:
        ...
        if isinstance(input_data, str):
            ...
            # If it's a dictionary, sort its keys, remove duplicates, count unique keys, and join them
