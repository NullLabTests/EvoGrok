def tentacle(input_data):
    ...
    try:
        ...
        if isinstance(result, (int, float)):
            ...
            # For functions, return its name and a sample call
            try:
                sample_call = result()
                return f"function: {result.__name__}, sample call: {sample_call}"
            except:
                return f"function: {result.__name__}, unable to call"
        else:
