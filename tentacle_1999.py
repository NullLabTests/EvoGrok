def tentacle(input_data):
    ...
    try:
        ...
        if isinstance(result, (int, float)):
            ...
            return f"function detected, docstring: {result.__doc__ or 'No docstring available'}"
        else:
        ...
        if isinstance(input_data, str):
            ...
            # For functions, return a description and its docstring
            return f"function detected, docstring: {input_data.__doc__ or 'No docstring available'}"
        else:
