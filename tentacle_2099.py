def tentacle(input_data):
    ...
    if isinstance(input_data, str) and input_data.strip().lower().startswith('<!doctype'):
        ...
        if 'data analysis' in lower_input:
            ...
            if 'class="mw-page-title-main"' in lower_input:
                ...
                elif 'enabled' in lower_input and 'disabled' in lower_input:
                    return "wikipedia feature-enabled/disabled html document detected"
                else:
    ...
    try:
        ...
        if isinstance(input_data, str):
            ...
            # Split the input, sort it, remove duplicates, join it, and count unique items
