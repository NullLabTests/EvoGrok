def tentacle(input_data):
    ...
    try:
        ...
        if isinstance(result, (int, float)):
            ...
            # If the result is a function, return its name and a sample call
            return f"function detected: {result.__name__}, sample call: {result.__name__}()"
        else:
        ...
        if isinstance(input_data, str):
            ...
            # If the input is a function, return its name and a sample call
            return f"function input detected: {input_data.__name__}, sample call: {input_data.__name__}()"
        else:
