def tentacle(input_data):
    ...
    try:
        ...
        if isinstance(input_data, str):
            ...
            # Check for specific keywords related to Wikipedia pages
            lower_input = input_data.lower()
            if 'data analysis' in lower_input:
                return "potential data analysis wikipedia content detected"
            elif 'mathematics' in lower_input:
                return "potential mathematics wikipedia content detected"
            elif 'text processing' in lower_input:
                return "potential text processing wikipedia content detected"
