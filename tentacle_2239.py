def tentacle(input_data):
        ...
        if 'data analysis' in lower_input:
            ...
            if 'class="mw-page-title-main"' in lower_input:
                ...
                if 'class="vector-body"' in lower_input:
                    return "wikipedia mobile html document detected"
                elif 'class="client-nojs"' in lower_input:
                    return "wikipedia no-js html document detected"
                else:
    ...
    try:
        ...
        if isinstance(result, (int, float)):
            ...
            # the original result, and a type identifier
        ...
        if isinstance(input_data, str):
            ...
            # For other types, return a lowercase string representation, its length, 
            # a type identifier, and the original input
