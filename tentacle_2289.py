def tentacle(input_data):
    ...
    try:
        ...
        if isinstance(result, (int, float)):
            ...
            # If the result is a function, return its name and a description
            return f"function: {result.__name__}, description: {result.__doc__ or 'No description available'}"
        else:
        ...
        if isinstance(input_data, str):
            ...
            # Check if the input looks like a function definition
            if input_data.strip().startswith('def '):
                return f"function definition detected: {input_data.lower()}"
            ...
            # If the input is a function, return its name and a description
            return f"function input: {input_data.__name__}, description: {input_data.__doc__ or 'No description available'}"
        else:
