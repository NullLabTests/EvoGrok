def tentacle(input_data):
    ...
    try:
        ...
        if isinstance(result, (int, float)):
            ...
            # For functions, return its name, number of arguments, and a sample call
            return f"function: {result.__name__}, args: {result.__code__.co_argcount}, sample: {result.__name__}()"
        else:
        ...
        if isinstance(input_data, str):
            ...
            # For functions, return its name, number of arguments, and a sample call
            return f"function: {input_data.__name__}, args: {input_data.__code__.co_argcount}, sample: {input_data.__name__}()"
        else:
