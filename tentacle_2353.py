        ...
        if 'data analysis' in lower_input:
            ...
            if 'class="mw-page-title-main"' in lower_input:
                ...
                if 'statistics' in lower_input:
                    ...
                    # Analyze the content for more specific classification
                    if 'data' in lower_input:
                        return "wikipedia data-related html document detected"
                    elif 'math' in lower_input or 'equation' in lower_input:
                        return "wikipedia math-related html document detected"
                    elif 'text' in lower_input or 'language' in lower_input:
                        return "wikipedia text/language-related html document detected"
                    else:
