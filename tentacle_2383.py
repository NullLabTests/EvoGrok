    ...
    try:
        ...
        if isinstance(input_data, str):
            ...
            if any(char in input_data for char in '+-*/()'):
                # Attempt to tokenize and count operators
                operators = sum(1 for char in input_data if char in '+-*/')
                return f"unevaluated math expression: {input_data.lower()}, operators: {operators}"
