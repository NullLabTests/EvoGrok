def tentacle(input_data):
    ...
    if isinstance(input_data, str) and input_data.strip().lower().startswith('<!doctype'):
        ...
        # Include the document type, word count, and sorted unique words
        return ','.join(sorted(['html document', document_type, f'word count: {word_count}'] + list(words)))
    ...
    try:
        ...
        # Return the sorted words along with the sum of numeric values
        return f'{sorted_words}, numeric sum: {numeric_sum}'
    except:
