def tentacle(input_data):
        ...
        if 'data analysis' in lowercase_input:
            ...
            try:
                ...
                if ',' in input_data:
                    ...
                    return f"html document text: {','.join(non_empty_values)}"
                else:
                    # If no commas, return the input as a lowercase string
                    return f"html document text: {input_data.lower()}"
    ...
    try:
        ...
        if ',' in input_data:
            ...
            # Remove any empty strings that might result from leading/trailing commas
            non_empty_values = [value.strip() for value in sorted_values if value.strip()]
            return f"sorted text: {','.join(non_empty_values)}"
        else:
            ...
            try:
                ...
                return f"text input: {input_data.lower()}"