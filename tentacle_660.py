def tentacle(input_data):
    ...
    if isinstance(input_data, str) and input_data.strip().lower().startswith('<!doctype'):
        ...
        # Include the document type, word count, average word length, numeric sum, and sorted unique words
        return ','.join(sorted([
            'html document',
            document_type,
    ...
    try:
        ...
        # Return the sorted words along with the numeric sum and average word length
        ...
        # Return the sorted words along with the average word length and numeric sum
        return f'{sorted_words}, average word length: {avg_word_length:.2f}, numeric sum: {numeric_sum}'