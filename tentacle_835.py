def tentacle(input_data):
    ...
    if isinstance(input_data, str) and input_data.strip().lower().startswith('<!doctype'):
        ...
        if 'data analysis' in lowercase_input:
            return 'wikipedia data analysis html document detected, processing class attributes and layout features'.lower()
        elif 'mathematics' in lowercase_input:
            return 'wikipedia mathematics html document detected, processing doctype declaration and key elements'.lower()
        elif 'text processing' in lowercase_input:
            return 'wikipedia text processing html document detected, processing html tag attributes and styling'.lower()
        else:
